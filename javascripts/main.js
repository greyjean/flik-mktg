...
// Author: Designova.
// Version 1.4 - Updated on 07 April 2014
...
$(function ($) {
     ...
     $('#intro, #about, #services, #portfolio, #why').css('height',vH);
    ...
    $('#intro h1, #about h1, #services h1, #portfolio h1, #why h1').waypoint(function() {
